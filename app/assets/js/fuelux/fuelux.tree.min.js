    ...
    var b = function(e, d) {
        ...
        this.$element.on("click", ".tree-item", a.proxy(function(f) {
        	if(!$(f.currentTarget).hasClass("tree-selected")){
                ...
                FW.trigerEvent('trigerChangeClass',$(f.currentTarget).find("div[id]").attr("id"),$(f.currentTarget).find("div[id]").attr("ctalias"));
            }
        },
        this));
            ...
            function(g) {
                ...
                function(h, j) {
                    ...
                    if (j.type === "folder") {
                        ...
                        i.find(".tree-folder-name").attr("id",h).attr("ctalias",j.ctalias).html(j.name);
                        ...
                        if (j.type === "item") {
                            ...
                            i.find(".tree-item-name").attr("id",h).attr("ctalias",j.ctalias).html(j.name);
                            i.data(j)
                        }
                    }
