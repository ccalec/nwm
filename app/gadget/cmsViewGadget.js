	...
	FW.register(
		{
			param:{
				...
				*@name id
				*@memberOf cmsViewGadget
				*@description 默认id 当nodeList的视图下，0标示查顶级栏目; contentList视图下，-1表示忽略id，查询全部
				*/
				id:null,
				/**
				*@name pageLen
			...
			*/
			onCreate:function(){
				...
				//获取url中参数id
				_this.id = _this.param.id || FW.use().getParameter("id");
				...
				//定义4种视图的参数 =============
				//视图: view_nodeList
				//nodeList 当前alias栏目列表 如果没有指定id，则查顶级栏目，如果指定，这查指定栏目的子栏目
				if(_this.param.viewObj == "nodeList"){
					_this.serverName = "queryNode";
					_this.doServerParam.param.nodeid = _this.id || "0";
				}
